export const UnsubscribeLetter = () => {
  ...
  const mailBody = `<!DOCTYPE html> <html lang='en'><head> <meta charset='UTF-8' /> <meta name='viewport' content='width=device-width, initial-scale=1.0' /> <meta http-equiv='X-UA-Compatible' content='ie=edge' />
        ...
        <style> td { padding: 20px 50px; background:#E5E5E5; border-radius: 6px; color: #444444; font-size: 20px; width: 100vw; margin: 0 auto; text-align: center; } </style> </head> <body>
        <table>
             <tr>
                <td>
                    <img src='https://st.depositphotos.com/1001911/4372/v/450/depositphotos_43725677-stock-illustration-wiping-tear-emoticon.jpg' alt="welcome" border="0" width="80%" style="display:block; margin: 20px auto;/>
